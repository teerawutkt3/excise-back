...
@Entity
@Table(name = "WS_PM_ASSESS_H")
public class WsPmAssessH extends BaseEntity {

	private static final long serialVersionUID = -7385181992914079480L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "WS_PM_ASSESS_H_GEN")
	@SequenceGenerator(name = "WS_PM_ASSESS_H_GEN", sequenceName = "WS_PM_ASSESS_H_SEQ", allocationSize = 1)
